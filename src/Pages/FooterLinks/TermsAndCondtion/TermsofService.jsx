...
<div className={classes.discription_Wrapper}>
  ...
  <p>
    ...
    this platform. We may refuse service or change eligibility at our discretion. You’re 
    responsible for complying with Ethiopian laws. Access to Q&A Forum is for your personal 
    use only and is revoked where prohibited by law or these terms.
  </p>
  <br />
  <p>
    We may suspend or terminate your access, account, or content at any time, with or without 
    notice, for violations of this Agreement or any reason we choose. We may monitor Q&A Forum 
    but are not obligated to do so.
  </p>
  <h3>Termination</h3>
  <p>
    We can end your access to Q&A Forum at any time, with or without cause or notice, 
    potentially deleting your data. Provisions like ownership, disclaimers, indemnity, and 
  ...
  <p>
    We don’t endorse or take responsibility for User Content or third-party links. We’re not 
    liable for content or actions from third-party sites linked on Q&A Forum.
  </p>
  <h3>Indemnity</h3>
  <p>
    You agree to defend, indemnify, and hold Q&A Forum, its officers, directors, employees, 
    and agents harmless from any claims, liabilities, damages, losses, or expenses (including 
    reasonable legal fees) arising from your User Content, use of Q&A Forum, or violation of 
    these Terms.
  </p>
  <h3>Governing Law and Jurisdiction</h3>
  <p>
